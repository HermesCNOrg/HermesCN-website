...
Every visible design decision must have a job: clarify hierarchy, improve scanning, guide action, communicate state, or support a real interaction. Do not add symbols, dividers, frames, faux-terminal marks, texture, or decorative footers just to make a surface feel "designed." When a visual element does not help the user understand, compare, decide, or act, remove it.
...
- Make every border, divider, icon, accent, and background earn its place by improving comprehension or interaction.
...
- Don't pile on decorative slashes, fake terminal chrome, ornamental line frames, abstract footer strips, or visual noise when they do not carry information or afford an action.
