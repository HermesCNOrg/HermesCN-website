...
| 相关 skill | [`obsidian`](/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`native-mcp`](/user-guide/features/mcp), [`arxiv`](/user-guide/skills/bundled/research/research-arxiv) |
